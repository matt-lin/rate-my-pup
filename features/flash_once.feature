...
Background: User already logged in
  ...
  Scenario: show error/warning once on dog_how_long
    ...
    And I should not see "To keep our database as accurate as possible, we are collecting information only for dogs that have been residing in their current home for six months or more. Please come back to our site and rate your dog after s/he has lived with you for a minimum of six months. Thank you." twice
  ...
  Scenario: show error/warning once on dog_breed
    ...
    And I should not see "Please select a breed in the list." twice
